...
public int overallScore()
{
   int s, s1, s2;
	if (score1 < score2 && score1 < score3) {
      ...
      s1 = score1;
      s2 = score3;// score changd to score 3 because 2 is less than three
   } else if (score3 < score1 && score3 < score2) {
      s1 = score1;
      s2 = score2;
   } else {
      s1 = score1;// larger than 50 changed to be equal to the numbers
      s2 = score2;// larger than 50 changed to be equal to the numbers
   }
   s = s1 + s2;
   return s;
}
